        ...
        for file_name in txt_files:
            ...
            try:
                with open(file_path, 'r') as file:
                    ...
                    command=  "python inference.py --model ./outputs/train_2024-11-25T19-20-03 --prompt \"" + str(prompt) + "\" --output-dir ./test_video_inference_output_for_lora_model --width 384 --height 384  --num-frames 48 --fps 12 --lora_path ./outputs/train_2024-11-26T16-06-09/lora/full_weights --lora_rank 16 --sdp"
